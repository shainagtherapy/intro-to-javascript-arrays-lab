...
const firstMovie = movies[0]; //Princess Bride

console.log(movies.length) //get the length)
console.log('This is the last movies:', movies[movies.length - 1]); //last listed movie
...
movies.push('Pirates of the Caribbean', 'Wizard of Oz')
console.log(movies)
movies.splice(1, 0, 'Aladdin')
...
const books = ['The Shining', 'Pride and Prejudice', 'Harry Potter', 'The Witches'];
